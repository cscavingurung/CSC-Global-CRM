...
export default function LeadIntakeForm({ onSubmitted, embedded = false, onSubmit, marketing = false }: LeadIntakeFormProps) {
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                pattern="(\+977[- ]?)?9\d{9}"
                title="Enter a valid Nepali mobile number, e.g. +977 98XXXXXXXX"
                className={fieldClass}
              />
            </div>
          </div>
