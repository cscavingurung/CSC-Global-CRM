...
import LeadIntakeForm, { LeadFormData } from './components/LeadIntakeForm';
...
export default function App() {
  ...
  const handleAddStudent = (data: LeadFormData) => {
  ...
  const handleAddMarketingLead = (data: LeadFormData) => {
    const stamp = formatSubmittedAt(new Date());
  ...
  const renderPage = () => {
    ...
    if (activeKey === 'marketing-add-lead')
      return <LeadIntakeForm embedded marketing onSubmit={handleAddMarketingLead} />;
    ...
    if (activeKey === 'new-intake')
      return <LeadIntakeForm embedded onSubmit={handleAddStudent} />;
